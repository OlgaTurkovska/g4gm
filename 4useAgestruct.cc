...
#include "ageStruct.cc"
#include "misc.cc"
#include "increment.cc"
...
int main() {
  ...
  ifstream fpi;
  fpi.open("../../g4gm-output/mai_G4mTree.asc", ios::in);
  if (fpi.is_open()) { cout << "mai file is open!" << endl; }

  ofstream fpo;
  fpo.open("../../g4gm-output/ccs.asc");
